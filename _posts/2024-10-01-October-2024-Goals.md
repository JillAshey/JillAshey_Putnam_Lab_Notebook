...
- Looking at shortstack output - fail 
- Looking at gene ext output 
- Manually extending Apul genes that didnt get gene extended
- Started running miranda on new Apul 3'UTRs 
- Lab meeting 
- Lab things
- Attempted to ship, fail 
- Running miranda with `-scale 8` 

### 20241029 

- Freezer chaos 
- TAR + putnam lab travel form
- Lots of miranda code with Apul e5
- Changed water for larvs 
- Attempted to submit Astrangia review 

### 20241030 

- Miranda with e5 apul 
- Writing accountability 
- Pacuta paper 
- Miranda for e5 deep dive 
- GO enrichment on mirna targets for e5
- Species comparisons for mirna targets e5 
...
- Species comparisons for shared mirnas 
- Resubmitted Astrangia review 
...
1. Dissertation proposal submission to grad school - done
2. e5 ncRNA complete methods + results + outline of discussion - done for the most part. finishing up miRNA target results 
3. Pacuta manuscript submission - nope but close to sending to coauthors for more edits 
4. AST results for manuscript - nope
5. JEB app - yes submitted
6. EGRA - yes submitted
7. Methods for Apul genome paper - done
8. Resubmit Astrangia review to Biology Letters - done

### Sample processing

1. Re-amp 6 WGBS e5 deep dive samples - yes, still need to send
2. Phys stuff for AST and Mcap DT - nope
3. Find and send DNA for e5 samples - done

### Data analysis

1. 3'UTR for AST 2021 (GENE EXT) and rerun miRanda with that info - can move forward
2. Run mirtarrnaseq for AST - no but can move forward
3. Run mirtarrnaseq for deep dive (Apul) - no but have all miranda data for this project
4. Mcap DT 2023 mRNA + miRNA counts matrix - yes for mRNA
5. Compiling all phys stuff for AST 2021 - nope

### Field work / travel 

1. Figure out travel for cbass workshop - chat w/ Sofia - kinda? flights booked
2. Apply for travel $$$ for cbass workshop - yes
3. Apply for travel $$$ for sicb - yes 

This was a very busy month and a lot of my data analysis goals got thrown off by revisions to the Astrangia review. I did get a lot of writing done! And several apps are submitted for travel support. 
