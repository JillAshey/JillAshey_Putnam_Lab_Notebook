...
- Made BIOS CV
- Writing about data analysis for dissertation proposal
...
- Lab meeting 
- Therapy 
- Working on GO figures for Pacuta 2022 manuscript 
...
1. Full draft of dissertation proposal - nope but should have it finished this Friday (5/3)
2. Write physiological results for Astrangia 2021 experiment - nope. Need to go through lab notebooks to make sure I got all phys samples processed
3. Resubmit Astrangia review manuscript - nope. Need to send editor the questions about why the manuscript is relevant to Biology Letters
4. Finish intro and methods for e5 ncRNA paper - kinda? waiting on some methods from Sam White  
5. Methods + results for Pacuta paper - Yes! 

### Sample processing

1. Extractions + 3' mRNA library prep with POC samples - Yes! Received data back & Hollie is currently processesing 
2. Library prep for WGBS (27 samples) - nope
3. Carbs for DT samples - nope

### Data analysis

1. Finish stats for Astrangia 2021 phys data (carbs) - nope, need to go through lab notebooks to make sure I got all phys samples processed
2. Complete Astrangia 2021 mRNA functional enrichment analysis - Yes! 
3. Run miranda with genes of interest, invoking strict seed binding - yes, currently running on the server
4. Assemble mito genome for Apul - nope but should be getting MitoHiFi up and running this week
5. Assemble coral genome for Apul - nope, but once I assemble the mito genome, I will purge the mito sequences and assemble the genome
6. Run miranda with lncRNAs - currently running on the server 
7. Run DEG analysis with lncRNAs - yes! Need to check poverA filtering 