...
- Coding for AST - looking at correlations between conditions 
- HMW DNA extraction 
- Submitted review for Microbial Ecology 
...
- Lab meeting 
- Helped Zoe 
- AST writing for seasonal enrichment 
- AST treatment GO enrichment 
...
1. Dissertation edits - done
2. AST manuscript writing - polishing for publication, maybe submit to JEB? - still stuck on whether to use the 3'UTR or full CDS as the miRNA target site?
3. Mcap 2023 manuscript writing - methods and results - no
4. CBASS - stats results - not really 

### Sample processing

1. Train Flo re molecular work - kinda
2. e5 lipid/metabolite protein assays - don't need to do anymore 
3. Anything else lab needs - helped with various things 

### Data analysis

1. AST 2021
	- phys univariate statistics. Remove Feb to see if this impacts stats at all - done
	- DESeq2 + GO enrichment for ambient Feb, June, and August to tell seasonal story of gene expression. - done
	- Exclude Feb time point and only include molecular for June + August amb and heat and run PERMANOVA. This will tell us if we care about treatment, time, or the interaction at all when looking at summer time points.
	- Do DESeq2 + GO enrichment for June + August amb and heat (exclude Feb) - done
	- mRNA-miRNA interactions - predicting interactions with miranda and correlations. network changes between june and aug amb v heat. short term network changes between june and august and long term network changes between feb, june, aug --> see how we can compare these statistically. look at papers that have done this stuff before and look at their stats - kinda done? Working on it
2. Mcap 2023 - nothing really 
	- clarification of polyadenlation - polyA v ribofree MZT and ZGA
	- subsetting genes of interest in Ayers et al. 2023
	- look at polyAD and polyA in relation to miRNAs
	- Process miRNA data once its back from Azenta 
3. e5 deep dive - check w Kathleen - no
4. e5 molecular mechanisms - check w Kathleen - no
