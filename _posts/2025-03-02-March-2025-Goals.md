...
1. e5 ncRNA complete draft of manuscript submit to biorxiv (chapter 1) - yes!
2. Edits for draft of Astrangia 2021 (chapter 2) - yes!
3. Write Mcap chapter 3 - yes!

### Sample processing

1. Send out Mcap polyA libraries - yes!
2. Protein assay for 96 lipid/metabolite e5 samples - no
3. Re-extract RNA samples for Mcap chapter - yes!

### Data analysis

1. Investigate pathways of interest for Mcap (chapter 3) - yes
2. Assess patterns over time of miRNA-mRNA interactions (chapter 3) - eh not really 
3. Make stats tables for phys analysis for AST 2021 (chapter 2) - yes

### Field work / travel 

1. Make sure URI pays me for CBASS and SICB - need to double check
