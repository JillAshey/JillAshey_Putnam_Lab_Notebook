...
- QC + alignment for DT Mcap 2023 
- Edits to Astrangia review manuscript 
- Trying to remake fig 4 for review manuscript 
- QC for s30 hifiasm assembly (busco + quast)
- Looked at busco results for primary s30 assembly 
- Alignment + assembly for DT Mcap 2023 + gene count matrix
- Sarah Donelan talk 
- 3'mRNA library prep 

### March 31

- QC for 3'mRNA library prep 
...
1. Full draft of dissertation proposal - nope
2. Write physiological results for Astrangia 2021 experiment - nope
3. Resubmit Astrangia review manuscript - nope, but got edits back from Hollie. Once I make the revisions, I will resubmit
4. Finish intro and methods for e5 ncRNA paper - still working on it
5. Diversity statement for dissertation proposal - working on it

### Sample processing

1. Finish miRNA library prep (8 samples) - done! 
2. Library prep for WGBS (27 samples) - nope
3. Carbs for DT samples - nope
4. Extractions, library prep, lipid extraction when AH is here - successfully extracted and prepped samples from POC 2023 spawning

### Data analysis
1. Finish stats for Astrangia 2021 phys data (carbs) - nope
2. Work on Astrangia 2021 mRNA functional enrichment analysis - nope
3. Run DESeq2 on miRNAs - yes
4. Continue with genome assembly for Apul - did a lot of genome things this month, making good progress. Currently at the assembly portion
5. Troubleshoot Pacuta goseq - goseq complete! Did a lot of work on Pacuta paper this month. I did lots of methods/results/discussion writing, along with functional enrichment analysis.
6. Test miranda - successfully ran miranda test! Need to figure out which flags will invoke strict seed binding

I felt pretty productive this month, even if its not reflected in the goals I set for myself (though I should try to stay on task). 